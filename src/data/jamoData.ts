...
export const jamoItems: JamoItem[] = [
  ...
  makeItem(
    ...
    '리을',
    'consonant',
    '계단처럼 꺾으며 다섯 획으로 차근차근 씁니다.',
    '라',
    [
      line('r-1', 1, [24, 24], [96, 24], '윗가로선을 긋기'),
      line('r-2', 2, [24, 24], [24, 54], '왼쪽 세로선을 내리기'),
      line('r-3', 3, [24, 54], [88, 54], '가운데 가로선을 긋기'),
      line('r-4', 4, [88, 54], [88, 82], '오른쪽 세로선을 내리기'),
  ...
  makeItem(
    ...
    '키읔',
    'consonant',
    '왼쪽 세로선을 기준으로 위 가로선과 가운데 가로선을 붙입니다.',
    '카',
    [
      line('k-1', 1, [28, 18], [28, 100], '왼쪽 세로선을 내리기'),
      line('k-2', 2, [28, 26], [92, 26], '윗가로선을 긋기'),
      line('k-3', 3, [28, 64], [84, 64], '가운데 가로선을 긋기'),
    ],
  ),
  makeItem(
    'ㅌ',
  ...
  makeItem(
    ...
    '피읖',
    'consonant',
    '윗가로선과 양쪽 세로선을 만든 뒤 가운데 가로선을 넣습니다.',
    '파',
    [
      line('p-1', 1, [24, 24], [96, 24], '윗가로선을 긋기'),
      line('p-2', 2, [24, 24], [24, 96], '왼쪽 세로선을 내리기'),
      line('p-3', 3, [96, 24], [96, 96], '오른쪽 세로선을 내리기'),
      line('p-4', 4, [24, 60], [96, 60], '가운데 가로선을 긋기'),
    ],
  ),
  makeItem(
    'ㅎ',
    '히읗',
    'consonant',
    '짧은 윗가로선을 긋고, 원과 가로선을 차례대로 더합니다.',
    '하',
    [
      line('h-1', 1, [34, 20], [82, 20], '윗가로선을 긋기'),
      circle('h-2', 2, [58, 68], 24, '아래 원을 둥글게 그리기'),
      line('h-3', 3, [28, 68], [88, 68], '가운데 가로선을 긋기'),
    ],
  ),
  makeItem(
    'ㅏ',
  ...
  makeItem(
    ...
    '유',
    'vowel',
    '윗가로선을 먼저 긋고 아래로 짧은 세로선 두 개를 왼쪽부터 차례로 내립니다.',
    '유',
    [
      line('yu-1', 1, [20, 42], [100, 42], '윗가로선을 왼쪽에서 오른쪽으로 긋기'),
      line('yu-2', 2, [42, 42], [42, 78], '왼쪽 짧은 세로선을 위에서 아래로 내리기'),
      line('yu-3', 3, [78, 42], [78, 78], '오른쪽 짧은 세로선을 위에서 아래로 내리기'),
    ],
  ),
  makeItem(
    'ㅡ',
